<div class="panel-heading clearfix">
    ...
    <div class="col-sm-12">
        <div class="btn-toolbar">
            ...
            @if(!$newSemester)
                <a href="{{ route("admin.pathways.pathway_semesters.destroy", [$model->pathway_id, $model->id]) }}" class="btn btn-danger"
                   data-method="delete"
...
@if(!$newSemester)
    @include('pathway_semester_courses._index', ['model' => $model, 'program_id' => $program_id])
@endif
