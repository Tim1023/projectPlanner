<div class="panel-body clearfix" ng-controller="adminPathwaySemesterCourseController as asc" ng-cloak>
    <server-side-data bind-property="asc.initialData"
                      value="<?php echo htmlentities($model); ?>"
                      parse-json="true"></server-side-data>
    <server-side-data bind-property="asc.initialData.program_id"
    ...
    <div class="table-responsive col-sm-12" ng-show="asc.pathwaySemester.courses.length > 0">
        <table class="table">
            <thead>
            <tr>
            ...
            <tbody>
                <tr ng-repeat="course in asc.pathwaySemester.courses | orderBy: '+course_number'">
                    ...
                    <td class="col-sm-3">
                        <div class="btn-group  pull-right">
                            <button type="button"
                                    ...
                                    disabled="disabled">
                                <span ng-show="asc.compulsoryCourses.indexOf(course.id) === -1">Elective</span>
                                <span ng-show="asc.compulsoryCourses.indexOf(course.id) !== -1">Compulsory</span>
                            </button>
                            <button type="button"
